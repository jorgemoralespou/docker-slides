...
* Proxy all downloads to create images
* How to backup data
...
* How to graphically view your images/layers
* ...

== How to proxy all downloads to create images
...
See http://jpetazzo.github.io/2014/06/17/transparent-squid-proxy-docker/[Source]
...
== How to copy files from the container
TODO: Write this

== How to customize behavior of a container
TODO: Write this

== How to graphically view your images/layers
You can use easily create a graph of your layers/images with:
...
This will create an image, in png format, with name docker.png, like the following:

image::docker_graph.png[Docker images graph]

NOTE: This options (-viz) will be removed. https://github.com/justone/dockviz[Here is a replacement]. 
